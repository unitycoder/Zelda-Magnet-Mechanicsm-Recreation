...
{
    public class InputListener_VerticalAxis : InputListenerBase<InputData_Axis>
    {
        #region Constants
        ...
        {
            return EInputEvent.VerticalAxis;
        }
        ...
        private void Update()
        {
            ...
            if (inputAmount == 0 && _inputState == EAxisInputState.Continuing)
            {
                ...
                OnInputEventTriggered?.Invoke(new InputData_Axis(
                    EInputEvent.VerticalAxis, inputAmount, _inputState));
            }
